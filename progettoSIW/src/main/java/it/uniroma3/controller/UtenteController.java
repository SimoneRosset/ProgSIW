...
public class UtenteController {
	...
	@Autowired
	private CentroDiFormazioneService centroDiFormazioneService;
	...
	public String inseriscinuovoUtente(@Valid @ModelAttribute Utente utente, 
			...
			@RequestParam(value="centroDiFormazione") CentroDiFormazione centroDiFormazione) {
		if (bindingResult.hasErrors()) {
			...
			utente.setRole(role);
			utente.setCentroDiFormazione(centroDiFormazione);
